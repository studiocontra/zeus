...
/**
 *
 * @param {string} content - Main wrapper of the page
 * @param {string} viewport - Parent of content
...
export default function smoothScroll(content, viewport, smoothness) {
	...
	viewport = viewport || content.parentNode;
	console.log(content, viewport);
